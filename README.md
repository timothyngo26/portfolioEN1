...
placeholder content — `Timothy Ngo`, a generic hero image, and so on.
...
> Replace every placeholder name in this site with my name, "Timothy Ngo."
> Update the LinkedIn and GitHub links in index.html's social box to my
> profiles: <your LinkedIn URL> and <your GitHub URL>.

Things to personalize:

- [ ] Your name, replacing `Timothy Ngo` everywhere it appears.
